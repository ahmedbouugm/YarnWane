 ...
 * This file demonstrates how to integrate Yarnwane with a web frontend
 */

// For React/Vue/Angular applications
export class YarnwaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YarnwaneClient(provider, contractAddress);
